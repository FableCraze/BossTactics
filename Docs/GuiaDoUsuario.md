...
O painel mostra os alvos e habilidades prioritários da masmorra atual. Clique em um inimigo para expandir ou recolher seus detalhes. O conteúdo também respeita o filtro de função e pode ser aberto ou ocultado pelo minipainel.
